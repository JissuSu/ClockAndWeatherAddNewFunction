			...
			public void run() {
				...
				if (AutoGetAddress) {
					if (!AddressUtils.updateAddress(context, appWidgetId)) {
						...
						Intent downIntent = new Intent(context,
								XKDownLoadUtil.class).putExtra("ifLoad", true);
				...
				context.startService(new Intent(context,
						LoadAlarmViewService.class));
				context.startService(new Intent(context,
						LoadBatteryViewService.class));
				context.startService(new Intent(context,
						LoadXKViewService.class));
				context.startService(new Intent(context,
						LoadEventsViewService.class));
				context.startService(new Intent(context,
						LoadLunerAndHolidayViewService.class));
				msg.sendToTarget();
			}
		}, "UpdateWeather");
